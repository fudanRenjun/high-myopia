...
# 定义LightGBM分类器
model_rf = lgb.LGBMClassifier(boosting_type='dart', random_state=42)
...
plt.plot([0, 1], [0, 1], color='gray', linestyle='--', lw=1, label='45 Degree Line')
...
plt.legend(loc='lower right', framealpha=0.9, fontsize=6)
plt.show()
...
plt.legend(loc='lower left', framealpha=0.9, fontsize=6)
plt.show()
