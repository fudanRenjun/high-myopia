...
grid_search = GridSearchCV(estimator=model_gb, param_grid=param_grid, cv=5, scoring='accuracy', n_jobs=-1, verbose=1)
...
# 宏平均ROC曲线
plt.plot(rf_FPR_final, rf_TPR_final, color='k', linestyle='-', label=f'Macro Average ROC AUC={rf_AUC_final:.4f}', lw=1)
